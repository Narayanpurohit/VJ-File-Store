...
BOT_TOKEN = environ.get("BOT_TOKEN", "7350676839:AAEM1YYpXT4keuhWoc-WYRSuAHfwoHkqouw")
...
DB_URI = environ.get("DB_URI", "mongodb+srv://Prityraj:4TccTm1HNxhtwcsG@cluster0.ljwrr.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# Channel Information
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-4796314616"))
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "http://jnmovies.space:8080/")
