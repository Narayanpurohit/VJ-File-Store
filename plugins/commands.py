        ...
        try:
            if not await check_verification(client, message.from_user.id) and VERIFY_MODE == True:
                btn = [[
                    ...
                    InlineKeyboardButton("How To Open Link & Verify", callback_data='tutorial')
                ]]
                await message.reply_text(
...
# Ask Doubt on telegram @KingVJ01
    ...
    if not files_:
        ...
        try:
            ...
            title = '@Jn_Bots ' + ' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@'), file.file_name.split()))
...
# Ask Doubt on telegram @KingVJ01
    ...
    if query.data == "tutorial":
        await query.message.reply_video("BAACAgQAAxkBAAJ0uWbOvZwkOrjm7x8LIJuzT7raeAkaAAJwEwAClqN4UtlPtdVT7an1NQQ", caption="Here is the tutorial video.")
